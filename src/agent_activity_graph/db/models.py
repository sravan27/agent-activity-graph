...
class EventRecord(Base):
    ...
    approved_exception_type: Mapped[str | None] = mapped_column(String(128), nullable=True)
    ...
    remediation_due_by: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    closure_status: Mapped[str | None] = mapped_column(String(64), nullable=True)
