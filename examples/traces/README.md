...
The default fixture, `openai_agents_invoice_review.json`, is adapted from four
official upstream patterns:
...
The goal of these fixtures is honesty, not theater: they prove the ingestion and
review surface against current public agent runtime patterns without pretending
they came from a private production system.
